    ...
    <div data-role="Header" className={`header-header ${props.rootClassName} `}>
      <div className="header-container">
        <Link to="/" className="header-navlink">
          <h1 className="header-heading textSM">{props.heading_lap}</h1>
        </Link>
        <Link to="/profilehtml" className="header-navlink1">
        ...
        <Link to="/blogs" className="header-navlink2">
      ...
      <div className="header-container3">
        ...
        <a
          href="https://twitter.com/not_sujal"
          target="_blank"
          rel="noreferrer noopener"
      ...
      <div data-type="MobileMenu" className="header-mobile-menu">
        ...
        <div className="header-mid">
          <Link to="/profilehtml" className="header-navlink4">
          ...
          <Link to="/blog-post-n-f-t" className="header-navlink5">
...
Header.defaultProps = {
  rootClassName: '',
  heading: 'Sujal Choudhari',
  heading_lap: 'Sujal Choudhari',
}

Header.propTypes = {
  rootClassName: PropTypes.string,
  heading: PropTypes.string,
  heading_lap: PropTypes.string,
}
